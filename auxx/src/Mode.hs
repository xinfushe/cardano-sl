...
makePubKeyAddressAuxx :: MonadAuxxMode m
                      => NetworkMagic -> SlotCount -> PublicKey -> m Address
...
deriveHDAddressAuxx :: MonadAuxxMode m
                    => NetworkMagic -> SlotCount
                    -> EncryptedSecretKey -> m Address
