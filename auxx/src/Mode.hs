...
instance HasConfiguration =>
    ...
    txpNormalize pm nm = withReaderT acRealModeContext . txNormalize pm nm
    txpProcessTx pm nm txpConfig =
        withReaderT acRealModeContext . txProcessTransaction pm nm txpConfig
