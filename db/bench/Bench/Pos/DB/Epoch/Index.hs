...
denseVectorBench index = mkIndexBench
    "DenseVector"
    (DenseVector.writeEpochIndex "denseVector.index" $ epochIndexToOffset index)
    (DenseVector.getEpochBlockOffset "denseVector.index")
