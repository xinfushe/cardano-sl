...
redeemAda
    ...
    -> CWalletRedeem
    -> m CTx
redeemAda pm nm txpConfig submitTx passphrase CWalletRedeem {..} = do
    ...
    redeemAdaInternal pm nm txpConfig submitTx passphrase crWalletId seedBs
  where
    invalidBase64 =
...
redeemAdaPaperVend
    ...
    -> m CTx
redeemAdaPaperVend pm nm txpConfig submitTx passphrase CPaperVendWalletRedeem {..} = do
    ...
    redeemAdaInternal pm nm txpConfig submitTx passphrase pvWalletId seedDecBs
  where
    invalidBase58 =
...
redeemAdaInternal
    ...
    -> ByteString
    -> m CTx
redeemAdaInternal pm nm txpConfig submitTx passphrase cAccId seedBs = do
